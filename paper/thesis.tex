...
\begin{lemma}
  ...
  $$ \textit{rewind} \; m \; (\textit{shift} \; \sigma) = \operatorname{snoc} m' , \sigma' \quad \text{where } m' , \sigma' = \textit{rewind} \; m \; \sigma $$
  where $\textit{shift} \coloneqq \textit{wk}_{\operatorname{Rpl}} \; (\operatorname{weak} \; \textit{id}_\subseteq)$
...
\begin{proof}
  ...
  The function \textit{shift} only affects the part of $\sigma$
